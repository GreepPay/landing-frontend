<template>
  <section>
    ...
    <div class="container">
      <h3
        class="!font-bold text-[12px] sm:text-base text-center text-[#C4C4C6] mb-5"
      >
        CORE FEATURES
      </h3>
      <h2
