<template>
    <section>
        ...
        <div class="container">
            <h3
                class="text-[12px] sm:text-base text-center text-[#C4C4C6] mb-5"
            >
                FEEDBACK
            </h3>
            <h2
    ...
    setup() {
        ...
        return {
            ...
            feedbacks: [
                {
                    description:
                        "I deal in electronics sales and repairs, I am looking forward to using GreepPay to receive payments from my Customers. ",
                    name: "Mr Kristen",
                    designation: "CEO of Atom Electronics",
                    avatar: "https://res.cloudinary.com/dindu/image/upload/v1738827290/official/avatar_k9qoa0.webp",
                },
                {
                    description:
                        "GreepPay will ease the payment system for my Customers by eradicating the need for currency conversion and sourcing for cash in order to make payments.",
                    name: "Benjamin Chibuzor",
                    designation: "CEO of Unique Hair ways Barbershop",
                    avatar: "https://res.cloudinary.com/dindu/image/upload/v1738828528/official/avatar-3_zhzlbs.webp",
                },
                {
                    description:
                        "As a Phone and Laptop Store owner, I am eager to use GreepPay to simplify payments for my Customers and improve their experience.",
                    name: "Mr Umar",
                    designation: "Asset Manager, Tekim Iletisim",
                    avatar: "https://res.cloudinary.com/dindu/image/upload/v1738828527/official/avatar-2_gjezok.webp",
                },
                {
                    description:
                        "I am very excited about GreepPay. It would be great to offer my Customers the opportunity to pay for my consumables in any African currency through GreepPay. ",
                    name: "Mr Ali",
                    designation: "Manager at Döner Ve Kebap",
                    avatar: "https://res.cloudinary.com/dindu/image/upload/v1738827290/official/avatar_k9qoa0.webp",
                },
                {
                    description:
                        "As a Restaurant Manager, I believe GreepPay will reduce the high cost experienced by my customers in converting African currency to our local currency. This will make transactions smoother for my customers.",
                    name: "Espanyan",
                    designation: "Manager at Choplife",
                    avatar: "https://res.cloudinary.com/dindu/image/upload/v1738828528/official/avatar-3_zhzlbs.webp",
                },
            ],
        };
